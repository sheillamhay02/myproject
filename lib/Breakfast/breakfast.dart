...
import 'package:recipe/cards/breakfastGridTile.dart';
            ...
            children: [
              GestureDetector(
                onTap:(){
                  ...
                  timer: '10 hrs and 7 mins',
                  ),
                  ),
                  );
                },
                child: BreakfastGridTile(imgscr:
                'https://i.pinimg.com/564x/e9/ff/0a/e9ff0a93a948a22d84af5171bb5fdb02.jpg',
                  title:'Longganisa',),
              ),
              GestureDetector(
                onTap: (){
                ...
                child: BreakfastGridTile(imgscr:
                'https://i.pinimg.com/564x/a3/11/d1/a311d19d705b9015e83a545b8e196066.jpg',
                  title:'Mechado',),
              ),
              GestureDetector(
                onTap: (){
                ...
                child: BreakfastGridTile(imgscr:
                'https://i.pinimg.com/474x/a5/73/d0/a573d064d8881a74062068a36ae3ab36.jpg',
                  title:'Tocino',),
              ),
              GestureDetector(
                onTap: (){
                ...
                child: BreakfastGridTile(imgscr:
                'https://i.pinimg.com/564x/18/28/86/1828860c0b8cfabd986f9e872141120c.jpg',
                  title:'Fried Chicken',),
              ),
              GestureDetector(
                onTap: (){
              ...
              GestureDetector(
                ...
                child: BreakfastGridTile(imgscr:
                'https://i.pinimg.com/564x/07/64/b8/0764b8ddd99a4352041397ae0a1c3e77.jpg',
                  title:'Corned Beef',),
              ),
